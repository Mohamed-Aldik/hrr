                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="workspace" class="col-md-4 col-form-label text-md-right">Workspace</label>

                                <div class="col-auto">
                                    <div class="input-group mb-2">
                                        <input id="workspace" type="text"
                                            class="form-control @error('workspace') is-invalid @enderror" name="workspace"
                                            value="{{ old('workspace') }}" required autocomplete="workspace">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">.domain.com</div>
                                        </div>
                                    </div>
                                </div>
